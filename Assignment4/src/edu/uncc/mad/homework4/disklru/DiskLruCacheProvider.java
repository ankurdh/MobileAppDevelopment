 ...
 * Homework 4
 * 
 * This is a wrapper around the core DiskLruCache implementation from:
 * https://github.com/JakeWharton/DiskLruCache. 
 * 
 * The wrapper is taken from 
 * http://stackoverflow.com/questions/10185898/using-disklrucache-in-android-4-0-does-not-provide-for-opencache-method
 * 
 */

package edu.uncc.mad.homework4.disklru;
...
import edu.uncc.mad.homework4.BuildConfig;
...
public class DiskLruCacheProvider {
	...
	public DiskLruCacheProvider(Context context){
		
		cacheDir = getDiskCacheDir(context);
        try {
			diskLruCache = DiskLruCache.open( cacheDir, 1, 1, DISK_CACHE_SIZE);
		} catch (IOException e) {
			Toast.makeText(context, "Failed to create Disk LRU Cache", Toast.LENGTH_LONG).show();
			e.printStackTrace();
		}
	}
